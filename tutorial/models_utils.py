...
def build_bool_sequence(demo_num, mode, shot_num_min):
  '''
  cond_list: list, whether to include the condition for each example
  qoi_kv_list: list, whether to include the QoI for each example
  qoi_k_list: list, whether to include the query for each example
  '''
  if mode == 'train':
